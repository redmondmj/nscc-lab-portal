...
Guacamole.AudioPlayer = function AudioPlayer() {
    ...
    /**
     * Change the volume, from 0 (off) to 1 (100%).
     * 
     * @private
     * @param {number} value
     */
...
Guacamole.RawAudioPlayer = function RawAudioPlayer(stream, mimetype) {
    ...
    /**
     * A Web Audio API GainNode object, or null if the Web Audio API is not
     * supported.
     * 
     * @private
     * @type {GainNode}
     */
    var gain = context && context.createGain();
